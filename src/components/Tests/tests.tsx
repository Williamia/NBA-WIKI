    ...
    return(
        <div className="content-testspage">
            ...
            <div className="subcard-test6">
                <div className="header-test-card6">
                <div className="title-test-card5 emblema-one-regular">
                    <span>34</span>
                </div>
                </div>

            <div className="card-name-player6">
                    <span className="span-name6">Giannis</span>
                    <span className="span-subname6">Antetokounmpo</span>
            </div>
                </div>
               <div className="subcard-overlay-test6" style={{backgroundImage: `url(${imgTestStar2})`}}>
               {/*<img className="img-card-overlay-test5" src={imgTest2} alt="imgtest2" /> */}
                <div className="card-overlay-test6">
                    <div className="card-overlay-test6-stats">
                        <div className="stats-test6">
                ...
                <div className="info-star-player6">
                    <div className="img-star-player6" style={{backgroundImage: `url(${imgTestStar2})`}} />
                    
                    {/*<span className="number-star-player5">Forward</span>*/}
                </div>
               </div>
            </div>
